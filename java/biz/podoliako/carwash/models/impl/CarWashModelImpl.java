...
@Component("CarWashModel")
public class CarWashModelImpl implements CarWashModel {

    private DaoFactory daoFactory;

    @Autowired
    public CarWashModelImpl(DaoFactory daoFactory){
    ...
    @Override
    public CarWash selectCarWash(Integer carWashId) throws SQLException {
